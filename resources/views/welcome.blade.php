...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@8.18.5/dist/sweetalert2.min.css" integrity="sha256-SXt8PUM3De2jpzjApkqTHl3rO6I8+lijRFzNQw255BE=" crossorigin="anonymous">

    <!-- Custom styles for this template -->
    <link href="{{ asset('public/frontend/css/clean-blog.min.css') }}" rel="stylesheet">
    <!-- we can use url() or URL::to() instead of asset -->
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('all.students')}}">Students</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@8.18.5/dist/sweetalert2.min.js" integrity="sha256-+czaCzSuQzOTJzDuRcSYmkjJqnYnRJUfn9URHjNNPu4=" crossorigin="anonymous"></script>
